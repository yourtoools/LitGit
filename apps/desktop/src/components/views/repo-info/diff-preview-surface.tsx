...
export function DiffPreviewSurface({
  ...
  if (state.kind === "guarded") {
    return (
      <div className="flex h-full items-center justify-center px-6">
        <div className="w-full max-w-md space-y-3 border border-border/70 bg-background p-4 text-center">
  ...
  if (state.kind === "unsupportedBinary") {
    return (
      <div className="flex h-full items-center justify-center px-6">
        <div className="space-y-2 border border-border/70 bg-background p-4 text-center">
