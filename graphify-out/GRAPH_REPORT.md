...
## Summary
- 2597 nodes · 5078 edges · 70 communities detected
...
- `handle_queue_prompt()` --calls--> `allow_remember_for_kind()`  [INFERRED]
  apps/desktop/src-tauri/src/askpass_ipc.rs → apps/desktop/src-tauri/src/askpass.rs
...
Cohesion: 0.03
Nodes (157): create_repository_branch_at_reference_inner(), create_repository_branch_inner(), delete_repository_branch_inner(), ensure_output_success(), get_repository_branches_inner(), get_repository_remote_names_inner(), rename_repository_branch_inner(), run_repo_git_output() (+149 more)
...
Cohesion: 0.03
Nodes (136): random_token(), askpass_session_accepts_correct_secret(), askpass_session_creation_returns_distinct_session_ids(), askpass_session_rejects_wrong_secret(), GitAuthBrokerState, GitAuthPromptContext, GitAuthPromptRecord, GitAuthPromptResponse (+128 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (96): AskpassSocketPath, create_windows_pipe(), error_response_serializes_correctly(), ErrorResponse, FailingPayload, GetResponseRequest, handle_get_response(), handle_queue_prompt() (+88 more)
...
Cohesion: 0.03
Nodes (100): clear_provider_token_secret(), create_temp_home_dir(), default_provider_config_should_use_system_agent(), disconnect_provider(), ensure_litgit_dir(), ensure_profile_id(), generate_profile_id(), get_all_provider_status() (+92 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (77): list_ai_models(), apply_auth_session_environment(), apply_auth_session_environment_clears_existing_askpass(), apply_auth_session_environment_from_snapshot(), apply_auth_session_environment_rejects_missing_socket_path(), apply_existing_git_preferences(), apply_existing_git_preferences_from_snapshot(), apply_git_preferences() (+69 more)

### Community 7 - "Community 7"
Cohesion: 0.07
Nodes (83): delete_remote_repository_branch_inner(), run_git_text_command(), git_command(), git_credential_reject(), git_error_message(), git_process_error_message(), is_git_authentication_message(), run_git_status() (+75 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (67): allow_remember_for_kind(), classify_prompt_kind(), create_temp_home_dir(), emit_git_auth_prompt(), GitAuthPromptPayload, normalize_optional_input(), provider_key_from_host(), resolve_oauth_prompt_response() (+59 more)
...
Cohesion: 0.08
Nodes (52): build_repository_commit_graph(), build_repository_commit_graph_assigns_lanes_and_parent_lanes_for_merges(), build_repository_commit_graph_tracks_graph_width_from_highest_lane(), clone_history_settings_state(), create_temp_git_repo(), create_temp_git_repo_with_commit(), create_temp_git_repo_with_merge_commit(), create_temp_git_repo_with_renamed_file() (+44 more)

### Community 15 - "Community 15"
Cohesion: 0.07
Nodes (38): KeyboardShortcutsDialog(), getChangeRepositoryShortcutKeys(), getCloseTabShortcutLabel(), getCommandPaletteShortcutLabel(), getKeyboardShortcutsShortcutLabel(), getNewTabShortcutLabel(), getNextTabShortcutLabel(), getOpenRepositoryShortcutLabel() (+30 more)

### Community 16 - "Community 16"
Cohesion: 0.07
Nodes (28): oauth_deep_link_round_trip_confirms_only_matching_staged_callback(), OAuthDeepLinkPayload, parse_oauth_deep_link(), parse_oauth_deep_link_returns_handoff_token(), RepositoryCommitFileDiff, RepositoryFileDiff, run(), main() (+20 more)
...
Cohesion: 0.08
Nodes (31): completeOAuthFlow(), disconnectProvider(), emitProviderStatusChanged(), generateProviderSshKey(), getProviderStatus(), redeemOAuthHandoffToken(), removeProviderSshKey(), resolveOAuthHandoffTokenFromInput() (+23 more)
...
- **Why does `git_command()` connect `Community 7` to `Community 0`, `Community 2`, `Community 6`, `Community 8`, `Community 10`, `Community 12`, `Community 14`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `available_launcher_apps()` connect `Community 4` to `Community 0`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `run()` connect `Community 16` to `Community 0`, `Community 2`, `Community 3`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
