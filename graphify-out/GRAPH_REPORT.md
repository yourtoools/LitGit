...
Cohesion: 0.03
Nodes (147): random_token(), askpass_session_accepts_correct_secret(), askpass_session_creation_returns_distinct_session_ids(), askpass_session_rejects_wrong_secret(), GitAuthBrokerState, GitAuthPromptContext, GitAuthPromptRecord, GitAuthPromptResponse (+139 more)
...
Cohesion: 0.05
Nodes (55): bitbucket_create_request_normalizes_repo_slug_for_spaces(), bitbucket_create_request_uses_workspace_slug(), bitbucket_created_repository_response_parses_clone_and_web_urls(), bitbucket_publish_targets_map_workspaces(), BitbucketCreatedRepositoryCloneLink, BitbucketCreatedRepositoryLinks, BitbucketCreatedRepositoryRecord, BitbucketLinkRecord (+47 more)
...
Cohesion: 0.06
Nodes (49): emit_git_auth_prompt(), ApprovedCloneCredential, clone_command_uses_auth_session_env(), clone_git_repository(), clone_prompt_provider_from_url(), CloneExecutionResult, CloneRepositoryProgress, create_initial_commit() (+41 more)
